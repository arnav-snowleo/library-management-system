...
public class Statistics extends JFrame{
	...
	panel.setBorder(new TitledBorder(new LineBorder(new Color(47, 79, 79), 2, true), "Issued-Book-Details",
	...
	panel_1.setBorder(new TitledBorder(new LineBorder(new Color(0, 204, 153), 2, true), "Returned-Book-Details",
